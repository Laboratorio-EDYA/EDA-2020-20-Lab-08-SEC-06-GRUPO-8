...
while True:
    ...
    if inputs == 1:
        ...
        print("\nRequerimiento No.2 del reto 3. Aún estamos en proceso :3 ")

    elif inputs == 5:   #Req. 3
        print("\nRequerimiento No.3 del reto 3. Aún estamos en proceso :3 ")

    elif inputs == 6:   #Req. 4
        print("\nRequerimiento No.4 del reto 3. Aún estamos en proceso :3 ")

    elif inputs == 7:   #Req. 5
        print("\nRequerimiento No.5 del reto 3. Aún estamos en proceso :3 ")

    elif inputs == 8:   #Req. 6*
        print("\nRequerimiento No.6 del reto 3. Aún estamos en proceso :3 ")

    elif inputs == 9:   #Req. 7*    
        print("\nRequerimiento No.7 del reto 3. Aún estamos en proceso :3 ")
